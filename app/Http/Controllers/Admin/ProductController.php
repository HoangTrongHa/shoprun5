...
class ProductController extends Controller
{
    ...
    public function add()
    {
        ...
        return view("admin.product.add-pd",compact("brands","cate","color","sizeShoes","sizeShirt"));
    }
    ...
    public function edit(Products $product)
    {
        ...
        return view("admin.product.edit-pd",compact("pro","brands","cate","color","sizeShoes","sizeShirt","pro_attb_vl","technical"));
    }
...
//        dd($pro_image);
        return view("admin.product.check",compact("data","arrtb_vl","color","sizeShoes","sizeShirt","pro_image","technical"));
    }
